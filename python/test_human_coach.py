...
class FakeEnv:
    def __init__(
        ...
        *,
        ...
        fusion_post_result_name: str = "Repeater",
        ...
        *,
        ...
        if isinstance(coach_bridge_command, dict) and str(coach_bridge_command.get("command") or "") == "fusion_step":
            ...
            resulting_after = {
                ...
                "plantTypeName": self.fusion_post_result_name if self.fusion_post_result_name else ("TwinSunFlower" if predicted_type == 1033 else str(predicted_type if predicted_type >= 0 else source_type)),
                "row": source_row,
                "column": source_col,
                "source": "logical",
            }
